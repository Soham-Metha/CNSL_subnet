...
int main()
{
    ...
    SET_BITS(sub_mask.as_int, class.mask_start_at - bit_cnt, 31);
    ...
    //===========================================================================================
    printf("\n┌────────────────────────────────────────────────────────────────────────┐");
    printf("\n│ IP           │  %-344s │", ip_to_str(ip, class.mask_start_at, 0));
    printf("\n│ MASK         │  %-344s │", ip_to_str(mask, class.mask_start_at, 0));
    ...
    for (int i = 1; i <= sub_cnt; i++) {
        printf("\n│              │  %-53s  │", "");
        printf("\n│ SUBNET NO.   │  %-53d  │", i);
        printf("\n│ SUBNET START │  %-344s │", ip_to_str(subnet_strt, class.mask_start_at, bit_cnt));
        printf("\n│ SUBNET END   │  %-344s │", ip_to_str(subnet_end, class.mask_start_at, bit_cnt));
